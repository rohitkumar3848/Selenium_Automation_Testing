...
*   2009-01-08 - internal - Replaced small with span
* ====================================================================
-->
 ...
 -->
   ...
   -->
    ...
    <xsl:template name="src.syntax-error">
        <xsl:message terminate="yes">Syntax error by WSDL source rendering in element
    ...
    <xsl:template name="about.detail">
        ...
        <div>
            ...
            This page has been generated by<big>wsdl-viewer.xsl</big>, version
            <xsl:value-of select="$version"/>
            <br/>
            Author:
            <a href="http://tomi.vanek.sk/">tomi vanek</a>
            <br/>
            Download at<a href="http://tomi.vanek.sk/xml/wsdl-viewer.xsl">http://tomi.vanek.sk/xml/wsdl-viewer.xsl</a>.
            <br/>
 ...
 -->
    ...
    <xsl:template match="ws2:endpoint" mode="service">
        ...
        <xsl:variable name="protocol">
            ...
            <xsl:choose>
                <xsl:when test="starts-with($binding-protocol, 'http://www.w3.org/2003/05/soap/bindings/HTTP')">over
                    HTTP
                </xsl:when>
                <xsl:otherwise/>
            </xsl:choose>
 ...
 -->
    ...
    <xsl:template name="src.render">
        <div class="page">
            ...
            <xsl:apply-templates
                    select="$consolidated-wsdl/*[local-name() = 'types']//xsd:import[@schemaLocation]/@schemaLocation | $consolidated-wsdl/*[local-name() = 'types']//xsd:include[@schemaLocation]/@schemaLocation"
                    mode="src.import"/>
        </div>
    </xsl:template>
